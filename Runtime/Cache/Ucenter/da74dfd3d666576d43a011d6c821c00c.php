<?php if (!defined('THINK_PATH')) exit();?><link href="/Application/Ucenter/Static/css/new-login.css" type="text/css" rel="stylesheet">
<div class="main-box modal-dialog">
    ...
    <div class="login-wrap modal-body">
        ...
        <div class="lg_left">
            ...
            <form action="/index.php?s=/ucenter/member/quicklogin.html" method="post" class="lg_lf_form ">

...
<?php echo hook('pageHeader');?>
    <link href="/Application/Home/Static/css/static_home.css" rel="stylesheet" type="text/css"/>
</head>
<body>
<!-- 头部 -->
    ...
    <div class="client-wrap">
        <div class="container client-box">
            ...
            <div class="row client">
                <div class="col-xs-3">
                    <div class="content">
                        <img src="/Application/Home/Static/images/ali.png"  class="img-responsive">
                ...
                <div class="col-xs-3">
                    <div class="content">
                        <img src="/Application/Home/Static/images/qxl.png"  class="img-responsive">
                ...
                <div class="col-xs-3">
                    <div class="content">
                        <img src="/Application/Home/Static/images/xq.png"  class="img-responsive">
                ...
                <div class="col-xs-3">
                    <div class="content">
                        <img src="/Application/Home/Static/images/km.png"  class="img-responsive">
